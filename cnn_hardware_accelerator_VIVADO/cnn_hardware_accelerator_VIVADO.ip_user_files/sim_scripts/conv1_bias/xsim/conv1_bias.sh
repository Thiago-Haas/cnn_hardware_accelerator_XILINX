...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot conv1_bias xil_defaultlib.conv1_bias -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim conv1_bias -key {Behavioral:sim_1:Functional:conv1_bias} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conv1_bias.wdb xsim.dir libdpi.so)
