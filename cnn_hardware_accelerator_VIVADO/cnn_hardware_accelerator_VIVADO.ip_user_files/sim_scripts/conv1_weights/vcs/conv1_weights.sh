...
#
# Script generated by Vivado on Tue Apr 22 18:18:24 -03 2025
...
#
# Usage        : conv1_weights.sh
#                conv1_weights.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conv1_weights.sh [-reset_run]
#                conv1_weights.sh [-reset_log]
#                conv1_weights.sh [-help]
#
...
#                script (type 'conv1_weights.sh -help' for more information).
#
...
# script info
echo -e "conv1_weights.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conv1_weights.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conv1_weights -o conv1_weights_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key conv1_weights_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conv1_weights_simv.daidir vcs_lib c.obj)
...
Usage: conv1_weights.sh [-step]\n\
Usage: conv1_weights.sh [-lib_map_path]\n\
Usage: conv1_weights.sh [-reset_run]\n\
Usage: conv1_weights.sh [-reset_log]\n\
Usage: conv1_weights.sh [-keep_index]\n\
