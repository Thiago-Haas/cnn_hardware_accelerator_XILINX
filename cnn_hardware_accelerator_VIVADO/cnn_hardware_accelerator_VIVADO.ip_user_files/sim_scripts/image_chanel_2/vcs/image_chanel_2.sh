...
#
# Script generated by Vivado on Wed Apr 23 10:01:03 -03 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : image_chanel_2.sh
...
#
# Usage        : image_chanel_2.sh
#                image_chanel_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                image_chanel_2.sh [-reset_run]
#                image_chanel_2.sh [-reset_log]
#                image_chanel_2.sh [-help]
#
...
#                script (type 'image_chanel_2.sh -help' for more information).
#
...
# script info
echo -e "image_chanel_2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./image_chanel_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.image_chanel_2 -o image_chanel_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./image_chanel_2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key image_chanel_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc image_chanel_2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./image_chanel_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: image_chanel_2.sh [-help]\n\
Usage: image_chanel_2.sh [-step]\n\
Usage: image_chanel_2.sh [-lib_map_path]\n\
Usage: image_chanel_2.sh [-reset_run]\n\
Usage: image_chanel_2.sh [-reset_log]\n\
Usage: image_chanel_2.sh [-keep_index]\n\
Usage: image_chanel_2.sh [-noclean_files]\n\n\
