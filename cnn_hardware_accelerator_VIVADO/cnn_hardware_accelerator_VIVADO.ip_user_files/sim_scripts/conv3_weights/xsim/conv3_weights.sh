...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot conv3_weights xil_defaultlib.conv3_weights -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim conv3_weights -key {Behavioral:sim_1:Functional:conv3_weights} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conv3_weights.wdb xsim.dir libdpi.so)
