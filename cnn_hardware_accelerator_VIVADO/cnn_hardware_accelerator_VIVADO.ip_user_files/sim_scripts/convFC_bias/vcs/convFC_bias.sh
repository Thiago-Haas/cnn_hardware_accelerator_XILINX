...
#
# Script generated by Vivado on Tue Apr 22 18:34:59 -03 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : convFC_bias.sh
...
#
# Usage        : convFC_bias.sh
#                convFC_bias.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                convFC_bias.sh [-reset_run]
#                convFC_bias.sh [-reset_log]
#                convFC_bias.sh [-help]
#
...
#                script (type 'convFC_bias.sh -help' for more information).
#
...
# script info
echo -e "convFC_bias.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./convFC_bias.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.convFC_bias -o convFC_bias_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./convFC_bias_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key convFC_bias_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc convFC_bias_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./convFC_bias.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: convFC_bias.sh [-help]\n\
Usage: convFC_bias.sh [-step]\n\
Usage: convFC_bias.sh [-lib_map_path]\n\
Usage: convFC_bias.sh [-reset_run]\n\
Usage: convFC_bias.sh [-reset_log]\n\
Usage: convFC_bias.sh [-keep_index]\n\
Usage: convFC_bias.sh [-noclean_files]\n\n\
