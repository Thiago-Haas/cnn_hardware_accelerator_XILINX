...
#
# Script generated by Vivado on Wed Apr 23 09:41:11 -03 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conv2_bias.sh
...
#
# Usage        : conv2_bias.sh
#                conv2_bias.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conv2_bias.sh [-reset_run]
#                conv2_bias.sh [-reset_log]
#                conv2_bias.sh [-help]
#
...
#                script (type 'conv2_bias.sh -help' for more information).
#
...
# script info
echo -e "conv2_bias.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conv2_bias.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conv2_bias -o conv2_bias_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./conv2_bias_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key conv2_bias_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conv2_bias_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conv2_bias.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conv2_bias.sh [-help]\n\
Usage: conv2_bias.sh [-step]\n\
Usage: conv2_bias.sh [-lib_map_path]\n\
Usage: conv2_bias.sh [-reset_run]\n\
Usage: conv2_bias.sh [-reset_log]\n\
Usage: conv2_bias.sh [-keep_index]\n\
Usage: conv2_bias.sh [-noclean_files]\n\n\
