...
#
# Script generated by Vivado on Wed Apr 16 16:28:25 -03 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : single_port_ram.sh
...
#
# Usage        : single_port_ram.sh
#                single_port_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                single_port_ram.sh [-reset_run]
#                single_port_ram.sh [-reset_log]
#                single_port_ram.sh [-help]
#
...
#                script (type 'single_port_ram.sh -help' for more information).
#
...
# script info
echo -e "single_port_ram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./single_port_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.single_port_ram -o single_port_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./single_port_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key single_port_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc single_port_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./single_port_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: single_port_ram.sh [-help]\n\
Usage: single_port_ram.sh [-step]\n\
Usage: single_port_ram.sh [-lib_map_path]\n\
Usage: single_port_ram.sh [-reset_run]\n\
Usage: single_port_ram.sh [-reset_log]\n\
Usage: single_port_ram.sh [-keep_index]\n\
Usage: single_port_ram.sh [-noclean_files]\n\n\
