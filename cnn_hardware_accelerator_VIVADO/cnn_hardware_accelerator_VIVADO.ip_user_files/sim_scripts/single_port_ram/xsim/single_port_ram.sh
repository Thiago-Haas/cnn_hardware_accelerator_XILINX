...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot single_port_ram xil_defaultlib.single_port_ram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim single_port_ram -key {Behavioral:sim_1:Functional:single_port_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb single_port_ram.wdb xsim.dir libdpi.so)
