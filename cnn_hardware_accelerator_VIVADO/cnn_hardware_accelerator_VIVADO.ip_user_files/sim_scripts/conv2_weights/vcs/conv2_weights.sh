...
#
# Script generated by Vivado on Wed Apr 23 09:42:27 -03 2025
...
#
# Usage        : conv2_weights.sh
#                conv2_weights.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conv2_weights.sh [-reset_run]
#                conv2_weights.sh [-reset_log]
#                conv2_weights.sh [-help]
#
...
#                script (type 'conv2_weights.sh -help' for more information).
#
...
# script info
echo -e "conv2_weights.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conv2_weights.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conv2_weights -o conv2_weights_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key conv2_weights_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conv2_weights_simv.daidir vcs_lib c.obj)
...
Usage: conv2_weights.sh [-step]\n\
Usage: conv2_weights.sh [-lib_map_path]\n\
Usage: conv2_weights.sh [-reset_run]\n\
Usage: conv2_weights.sh [-reset_log]\n\
Usage: conv2_weights.sh [-keep_index]\n\
