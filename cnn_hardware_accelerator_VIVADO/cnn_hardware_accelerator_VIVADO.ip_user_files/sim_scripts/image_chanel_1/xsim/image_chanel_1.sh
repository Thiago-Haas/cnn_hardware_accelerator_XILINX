...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot image_chanel_1 xil_defaultlib.image_chanel_1 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim image_chanel_1 -key {Behavioral:sim_1:Functional:image_chanel_1} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb image_chanel_1.wdb xsim.dir libdpi.so)
