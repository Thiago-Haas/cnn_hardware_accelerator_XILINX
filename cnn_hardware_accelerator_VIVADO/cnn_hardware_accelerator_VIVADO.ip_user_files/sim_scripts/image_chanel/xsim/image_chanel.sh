...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot image_chanel xil_defaultlib.image_chanel -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim image_chanel -key {Behavioral:sim_1:Functional:image_chanel} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb image_chanel.wdb xsim.dir libdpi.so)
