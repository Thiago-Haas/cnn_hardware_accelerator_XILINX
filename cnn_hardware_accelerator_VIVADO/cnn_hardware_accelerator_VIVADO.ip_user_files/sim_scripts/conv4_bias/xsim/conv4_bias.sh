...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot conv4_bias xil_defaultlib.conv4_bias -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim conv4_bias -key {Behavioral:sim_1:Functional:conv4_bias} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conv4_bias.wdb xsim.dir libdpi.so)
