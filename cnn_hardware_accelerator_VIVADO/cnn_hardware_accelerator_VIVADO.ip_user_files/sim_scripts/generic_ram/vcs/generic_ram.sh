...
#
# Script generated by Vivado on Thu Apr 17 14:42:33 -03 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : generic_ram.sh
...
#
# Usage        : generic_ram.sh
#                generic_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                generic_ram.sh [-reset_run]
#                generic_ram.sh [-reset_log]
#                generic_ram.sh [-help]
#
...
#                script (type 'generic_ram.sh -help' for more information).
#
...
# script info
echo -e "generic_ram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./generic_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.generic_ram -o generic_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./generic_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key generic_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc generic_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./generic_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: generic_ram.sh [-help]\n\
Usage: generic_ram.sh [-step]\n\
Usage: generic_ram.sh [-lib_map_path]\n\
Usage: generic_ram.sh [-reset_run]\n\
Usage: generic_ram.sh [-reset_log]\n\
Usage: generic_ram.sh [-keep_index]\n\
Usage: generic_ram.sh [-noclean_files]\n\n\
