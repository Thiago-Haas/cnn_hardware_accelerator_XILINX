...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L secureip -L xpm --snapshot generic_ram xil_defaultlib.generic_ram -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim generic_ram -key {Behavioral:sim_1:Functional:generic_ram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb generic_ram.wdb xsim.dir libdpi.so)
