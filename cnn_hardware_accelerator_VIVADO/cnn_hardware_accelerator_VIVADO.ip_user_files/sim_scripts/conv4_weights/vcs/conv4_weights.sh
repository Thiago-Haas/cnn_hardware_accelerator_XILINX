...
#
# Script generated by Vivado on Wed Apr 23 09:53:08 -03 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conv4_weights.sh
...
#
# Usage        : conv4_weights.sh
#                conv4_weights.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conv4_weights.sh [-reset_run]
#                conv4_weights.sh [-reset_log]
#                conv4_weights.sh [-help]
#
...
#                script (type 'conv4_weights.sh -help' for more information).
#
...
# script info
echo -e "conv4_weights.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conv4_weights.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conv4_weights -o conv4_weights_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./conv4_weights_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key conv4_weights_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conv4_weights_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conv4_weights.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conv4_weights.sh [-help]\n\
Usage: conv4_weights.sh [-step]\n\
Usage: conv4_weights.sh [-lib_map_path]\n\
Usage: conv4_weights.sh [-reset_run]\n\
Usage: conv4_weights.sh [-reset_log]\n\
Usage: conv4_weights.sh [-keep_index]\n\
Usage: conv4_weights.sh [-noclean_files]\n\n\
