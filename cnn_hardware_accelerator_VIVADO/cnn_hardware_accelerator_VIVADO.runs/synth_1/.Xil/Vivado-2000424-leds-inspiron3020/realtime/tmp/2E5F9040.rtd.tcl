...
set genomeRtd $env(RT_TMP)/2E5F9040.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {conv1_op__parameterized5__GB3}]"
...
set genomeName [subst -nocommands -novariables {conv1_op__parameterized5__GB3}]
