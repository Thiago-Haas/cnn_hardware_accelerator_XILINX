...
HD_PWD='/home/haas/Workspace/CNN_ACELERATOR/cnn_hardware_accelerator_VIVADO/cnn_hardware_accelerator_VIVADO/cnn_hardware_accelerator_VIVADO.runs/single_port_ram_synth_1'
cd "$HD_PWD"
